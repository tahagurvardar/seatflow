  ...
  return (
    <section className="bg-slate-50 py-14 sm:py-20">
      <Container>
        ...
        <p className="mt-4 rounded-2xl bg-amber-50 p-4 text-sm text-amber-900">Booking and revenue belong to the organizer and are not shown here. Venue operators can see configured session timing but cannot edit organizer event content.</p>
